            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  маркетплейса «Calibre Store» (далее — «Платформа»). Мы
                  серьезно относимся к защите ваших персональных данных и
                  обязуемся обеспечивать их конфиденциальность и безопасность.
                </p>
