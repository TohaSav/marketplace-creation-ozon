...
const navigation = [
  ...
  { name: "Выплаты", href: "/admin/payouts", icon: "Banknote" },
  { name: "Настройки ЮКассы", href: "/admin/payment-settings", icon: "CreditCard" },
  ...
  { name: "Пополнение", href: "/admin/payments", icon: "Wallet" },
